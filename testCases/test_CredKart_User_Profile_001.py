...
class Test_User_Profile_Class:
    ...
    def test_CredKart_Title_001(self):
        ...
        if self.driver.title == "CredKart":
            ...
            allure.attach.file(r"D:\Credence 37 Batch\4. Automation Testing\Pytest Credkart Framework\Screenshots\User login Successfully.png", name="User login Successfully", attachment_type=allure.attachment_type.PNG)
            assert True
        else:
