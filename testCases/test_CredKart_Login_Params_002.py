...
from Utils.ReadConfig import ReadConfigClass
from Utils.Logger import log_generator_class
...
class Test_User_Profile_Class:
    ...
    def test_CredKart_Login_params_004(self,get_data_for_login):
        ...
        if self.lp.verify_menu() == "Pass":
            ...
            self.driver.save_screenshot(r"D:\Credence 37 Batch\4. Automation Testing\Pytest Credkart Framework\Screenshots\User login Successfully.png")
            ...
            self.driver.save_screenshot(r"D:\Credence 37 Batch\4. Automation Testing\Pytest Credkart Framework\Screenshots\User login Failed.png")
